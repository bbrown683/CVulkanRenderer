...
public:
    ...
    CVulkanRenderPass(vk::Device device, vk::Format colorFormat, vk::Format depthStencilFormat = vk::Format::eUndefined, vk::SampleCountFlagBits samples = vk::SampleCountFlagBits::e1, vk::ClearColorValue clearColor = vk::ClearColorValue())
        ...
        std::vector<vk::AttachmentDescription> colorAttachments = { vk::AttachmentDescription({}, colorFormat, samples,
        ...
        if(depthStencilFormat != vk::Format::eUndefined) {
            auto depthStencilAttachment = vk::AttachmentDescription({}, depthStencilFormat, samples,
                                                                    vk::AttachmentLoadOp::eClear, vk::AttachmentStoreOp::eStore,
                                                                    vk::AttachmentLoadOp::eDontCare, vk::AttachmentStoreOp::eDontCare,
                                                                    vk::ImageLayout::eUndefined, vk::ImageLayout::ePresentSrcKHR);
            ...
            subpasses.push_back(vk::SubpassDescription({}, vk::PipelineBindPoint::eGraphics, nullptr, colorReferences, nullptr, &depthStencilReference));
        } else {
            subpasses.push_back(vk::SubpassDescription({}, vk::PipelineBindPoint::eGraphics, nullptr, colorReferences));
        }
        ...
        auto renderPassInfo = vk::RenderPassCreateInfo({}, colorAttachments, subpasses, subpassDependency);
