...
CVulkanBufferAllocator::CVulkanBufferAllocator(vk::Instance instance, vk::PhysicalDevice physicalDevice, vk::Device device) {
...
VmaAllocation CVulkanBufferAllocator::CreateBuffer() {
    // TODO: Fill these out.
...
void CVulkanBufferAllocator::FreeBuffer(VmaAllocation allocation) {
    vmaFreeMemory(allocator, allocation);
}

VmaAllocator* CVulkanBufferAllocator::GetVmaAllocator() {
    return &allocator;
}

CVulkanBuffer::CVulkanBuffer(vk::Device device, VmaAllocator* allocator) : device(device), allocator(allocator) {
